...
const displayReport = (req, res) => {
  ...
  Promise.all([getCodewars('astroash'), getFreeCodeCamp('astroash'), getGithubPage('http://www.astroash.com/'), getW3Validator('http://www.astroash.com/'), getGithubRepos('astroash')])
    .then((values) => {
      const summaryObject = {};
